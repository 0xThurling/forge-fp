...
| [io.md](io.md) | **New** — `io.hpp` file IO (P0), `interact`/`lift_io` (P1); `grid.hpp` 2D helpers (P0), 3D/windows (P1); match (`case_`/`cond`/`when`/`otherwise`), `fp::ops`, `FP_TRY` macro (P1), `unpack`/`value_or` (P1/P2) |
